module.exports = {
  register: {
    ...
    done: (name, schedule) => `Muito bom. Parabéns pelo cadastro!!\n\nObrigado por se cadastrar no BOT Motiva. Logo, logo a sua frase chegará para melhorar ${schedule.split(':')[0] > 19 && schedule.split(':')[0] < 4 ? "a sua noite" : "o seu dia"}, ${name}`,
  },
  actionMenu: {
